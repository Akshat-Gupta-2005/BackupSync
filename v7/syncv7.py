...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "FolderSync — Two-way folder sync with CREATE/UPDATE/DELETE/CONFLICT handling\n"
    ...
    for pair in pairs:
        ...
        actions = scan_folders(src, dst, state_file=sf)

        # PASS 2: Preview
        print_preview(name, src, dst, actions)
        ...
        # PASS 4: Execute
        try:
            result = sync_folders(src, dst, dry_run=False, log_file=args.log, state_file=sf)
